...
&#x200F;<br> ─| **استفاده از پورت‌های اختصاصی تور :** 
...
&#x200F;<br> ─| **محدودیت‌ها :** به دلیل مکانیزم عملکرد proxychains-Ng و socksify ممکن است برخی برنامه‌ها یا دستورات به درستی اجرا نشوند .
...
<details>
  <summary dir="rtl" style="text-align: right;">1 | Setup Dante|Socksify + Tor</summary>

  <p dir="rtl" style="text-align: right;">
   
  🧰 **این گزینه برای 'نصب و همگام سازی خودکار Socksify با Tor' استفاده میشود.**
...
![image](https://github.com/kalilovers/sonchain/blob/main/assets/images/menu/uninstallmenu.png)
  ...
  <br><br> 🗑 **گزینه مورد نظر را برای حذف انتخاب کرده و تایید کنید تا عملیات نصب آغاز شود**.
